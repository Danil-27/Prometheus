    ...
    <div class="flex flex-col lg:flex-row xxl:max-w-[1400px] mt-[240px] xs:mt-[270px] min-[580px]:mt-[320px] lg:mt-[100px] xxl:mx-auto bg-[url('@/assets/svg/social/bg-social-block.svg')] bg-[position:right,center]  bg-no-repeat bg-white lg:pr-[50px] p-[20px] xs:p-[30px] lg:py-[45px] rounded-base ">
      <div class="lg:w-6/12 relative">
        <div @click="toggleNum(1)" :class="[
          'absolute w-[180px]  xs:w-[220px] min-[580px]:w-[250px] lg:w-[300px] min-[1100px]:w-[350px] xl:w-[410px] top-[-210px] xs:top-[-260px] min-[580px]:top-[-290px] lg:top-[26%] lg:-translate-y-1/2 left-[30%] min-[700px]:left-[36%] lg:left-[30%] translate-x-[-50%] aspect-[1] rotate-[-5deg] transition-all duration-500 ease-in-out cursor-pointer   ',
          ...
          <div class="relative before:content-[''] before:absolute before:inset-0 before:top-0 before:left-0 before:h-full before:w-full before:z-[10] before:rounded-[35px] before:bg-[linear-gradient(90deg,rgba(0,0,0,0.1)_0%,rgba(255,255,255,0)_100%)] before:bg-[rgba(0,0,0,0.1)]">
            <NuxtImg loading="lazy" src="/images/social/Daniil.webp" alt="Даниил" width="400" height="440" class="max-w-[100%] h-full relative z-[1] rounded-[35px] object-cover" />
        ...
        <div @click="toggleNum(0)" :class="[
          'absolute w-[180px] xs:w-[220px] min-[580px]:w-[250px] lg:w-[300px] min-[1100px]:w-[350px] xl:w-[410px] top-[-210px] xs:top-[-260px] min-[580px]:top-[-290px] lg:top-[70%] lg:-translate-y-1/2 left-[70%] min-[700px]:left-[64%] lg:left-[58%] translate-x-[-50%] aspect-[1] rotate-[4deg] transition-all duration-500 ease-in-out cursor-pointer',
          toggleLink === 0 ? 'z-[20] scale-[1.05]' : 'z-[10] scale-[0.95] opacity-70'
        ]">
          <div class="relative before:content-[''] before:absolute before:inset-0 before:top-0 before:left-0 before:h-full before:w-full before:z-[10] before:rounded-[35px] before:bg-[linear-gradient(90deg,rgba(0,0,0,0.1)_0%,rgba(255,255,255,0)_100%)] before:bg-[rgba(0,0,0,0.1)]">
            <NuxtImg loading="lazy" src="/images/social/Julia.webp" alt="Julia" width="400" height="440" class="max-w-[100%] h-full relative z-[1] rounded-[35px] object-cover" />
