// elegant
import elegantXL from '~/assets/images/page_progect/desctop/elegant/about_Large.png';
...
// cliff
import cliffXL from '~/assets/images/page_progect/desctop/cliff/about_Large.png';
...
// complexElegant
import complexElegantXL from '~/assets/images/page_progect/desctop/complexElegant/about_Large.png';
...
export const contentAbout: Content[][] = [
  [
    ...
    { title: 'Комнаты:', text: '4 комнаты, кухня-гостиная, 2 санузла, гардероб, лоджия' },
  ...
  [
    ...
    { title: 'Комнаты:', text: '3 комнаты, кухня-гостиная, гардероб интегрирован в мастер-спальню, 2 санузла, лоджия' },
