  ...
  <div class="swiperMain relative">
    <ClientOnly>
      ...
      >
        ...
        >
          <div class="swiperMain__content relative h-[100%] w-[100%] sm:rounded-xl shadow-image">
            <img class="swiperMain__img h-[100%] w-[100%] object-cover" :src="slide.src" :alt="slide.alt" />
            <div
      ...
      <!--* Modal ------------------------ -->
      <Modal v-model="isOpen" custom-class="modal-swiper">
        <template #content>
          <SwiperDeeper />
        </template>
      </Modal>
