<template>
  <section class="custom-container section-margin-top">
    ...
    >
      <div
        class="relative lg:col-span-2 xl:col-span-2 xl:order-4 flex flex-col justify-between rounded-base text-[30px] p-[15px] xs:p-[20px] md:p-[30px] bg-cover bg-center xxl:bg-[-10px] bg-no-repeat bg-[url('~/assets/images/price/corner.png')]"
      >
      ...
      <div
        class="lg:col-span-2 xl:col-span-2 xl:order-2 flex flex-col justify-between rounded-base text-[30px] p-[15px] xs:p-[20px] md:p-[30px] bg-cover bg-center bg-no-repeat bg-[url('~/assets/images/price/sofa.png')]"
      >
        <div>
      ...
      <div
        class="lg:col-span-3 xl:row-span-2 xl:col-span-1 xl:order-1 flex flex-col justify-between xl:flex-col-reverse rounded-base text-[30px] p-[15px] xs:p-[20px] md:p-[30px] xl:pb-[0px] xl:pl-[0px] bg-no-repeat bg-cover bg-center bg-[url('~/assets/images/price/home_xxs.png'),url('~/assets/images/price/background.png')] xs:bg-[url('~/assets/images/price/home_xs.png'),url('~/assets/images/price/background.png')] sm:bg-[url('~/assets/images/price/home_xxs.png'),url('~/assets/images/price/background.png')] min-[770px]:bg-[url('~/assets/images/price/home_md.png'),url('~/assets/images/price/background.png')] lg:bg-[url('~/assets/images/price/home_lg.png'),url('~/assets/images/price/background.png')] xl:bg-[url('~/assets/images/price/home_xl.png')] xxl:bg-[url('~/assets/images/price/home_xxl.png')]"
      >
